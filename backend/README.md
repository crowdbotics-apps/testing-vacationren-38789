...
## Project Structure
    ...
    ├── testing_vacationren_38789  # Django project configurations
...
1. Clone this repo and `cd testing_vacationren_38789`
...
2. Clone this repo and `cd testing_vacationren_38789`
